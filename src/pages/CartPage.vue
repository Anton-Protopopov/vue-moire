  ...
  <main class="content container">
    <div class="content__top">
      ...
      <span class="content__info"> {{$store.state.cartProducts.length}} товара </span>
        ...
        <div v-if ="$store.state.productsLoadingFailed">Произошла ошибка при загрузке товаров
        </div>
        <div class="loader" v-if="$store.state.productLoading">
      ...
      <form class="cart__form form" action="#" method="POST">
        <div class="cart__field">
          <ul class="cart__list" >
            ...
            <CardItem v-for="item in product" :key="item.productId" :item="item"/>
          </ul>
        </div>
        ...
        <div class="cart__block">
          ...
          <p class="cart__price">Итого:
             <span>{{totalPrice | namberFormat}} ₽</span>
            </p>
